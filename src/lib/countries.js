// Same list used by the mobile app's editprofile.tsx country picker, so a
// Location code saved from either app renders correctly in the other.
export const COUNTRIES = [
    ...
    { code: 'BF', name: 'Burkina Faso' }, { code: 'BG', name: 'Bulgaria' }, { code: 'KH', name: 'Cambodia' },
    { code: 'CM', name: 'Cameroon' }, { code: 'CA', name: 'Canada' }, { code: 'CF', name: 'Central African Republic' },
    { code: 'TD', name: 'Chad' }, { code: 'CL', name: 'Chile' }, { code: 'CN', name: 'China' },
    { code: 'CO', name: 'Colombia' }, { code: 'CG', name: 'Congo' }, { code: 'CR', name: 'Costa Rica' },
    ...
    { code: 'GN', name: 'Guinea' }, { code: 'HT', name: 'Haiti' }, { code: 'HN', name: 'Honduras' },
    ...
    { code: 'TZ', name: 'Tanzania' }, { code: 'TH', name: 'Thailand' }, { code: 'TT', name: 'Trinidad and Tobago' },
