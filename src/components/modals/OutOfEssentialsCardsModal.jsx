...
// Shown to an Essentials-tier account that's used up all 5 cards for the
// month — same layout as OutOfFreeCardsModal, with copy adjusted since this
// account is already paying (not starting from scratch).
const OutOfEssentialsCardsModal = ({ onClose, onContinue }) => {
    ...
    return (
        <div className="eim-overlay" onClick={onClose}>
            <div className="eim-panel" onClick={e => e.stopPropagation()}>
                ...
                <p className="eim-eyebrow">You've used your 5 cards this month.</p>
...
export default OutOfEssentialsCardsModal;
