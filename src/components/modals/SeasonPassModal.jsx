...
// Season Pass info modal — opened from the Membership wizard's Season Pass
// row (Step 2). Sibling of SeasonPassRequiredModal (shown instead when a
// season-exclusive card is blocked) but framed as a plain feature callout
// rather than a paywall: "Season 1" / "Season Pass" heading, no explaining
// away why access is blocked.
const SeasonPassModal = ({ onClose, onGetSeasonPass }) => {
    return (
        <div className="eim-overlay" onClick={onClose}>
            <div className="eim-panel" onClick={e => e.stopPropagation()}>
                ...
                <p className="spm-season-label">SEASON 1</p>
                <h3 className="eim-headline">Season Pass</h3>
